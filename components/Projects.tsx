...
const projects: Project[] = [
  ...
  {
    name: "Nova",
    description: "Local AI terminal assistant powered by Ollama with token-by-token streaming, markdown rendering, and configurable profiles for different use cases.",
    tech: ["Python", "Ollama", "CLI"],
    code: "https://github.com/dizzyfrogs/nova",
    image: "/projects/nova.png",
  },
  {
    name: "Glean",
    description: "Campus food waste tracking and redistribution platform connecting kitchen staff, managers, and food banks - built at ODU Hackathon 2026.",
    tech: ["Next.js", "TypeScript", "Tailwind", "Zustand", "OpenAI"],
    code: "https://github.com/dizzyfrogs/glean",
    image: "/projects/glean.png",
  },
  {
    name: "Resonance",
    description: "iOS breathing pacer that uses your camera to verify you're actually breathing through real-time physiological monitoring - built at TechSTL Code 'Til Dawn Hackathon 2026.",
    tech: ["Swift", "SwiftUI"],
    code: "https://github.com/dizzyfrogs/resonance",
  ...
  {
    name: "Forgotten Rifts",
    description: "PaperMC plugin adding a magical portal system with color-coded frequency pairing and command-free activation via Spectral Arrows.",
    tech: ["Java"],
    code: "https://github.com/dizzyfrogs/forgottenrifts",
    image: "/projects/forgottenrifts.png",
  },
  {
